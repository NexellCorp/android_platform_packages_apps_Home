...
public class Home extends Activity {
     ...
     */
    private static final String LOG_TAG = "SampleHome";
    ...
    public void onCreate(Bundle icicle) {
        ...
        Slog.i(LOG_TAG, "onCreate start");
        setDefaultKeyMode(DEFAULT_KEYS_SEARCH_LOCAL);

        setContentView(R.layout.home);
        Slog.i(LOG_TAG, "setContentView End");
        ...
        bindApplications();
        Slog.i(LOG_TAG, "bindApplications End");
        bindFavorites(true);
        Slog.i(LOG_TAG, "bindFavorites End");
        bindRecents();
        Slog.i(LOG_TAG, "bindRecents End");
        bindButtons();
        Slog.i(LOG_TAG, "bindButtons End");
    ...
    protected void onResume() {
        Slog.i(LOG_TAG, "onResume start");
        super.onResume();
        bindRecents();
        Slog.i(LOG_TAG, "onResume end");
    }
